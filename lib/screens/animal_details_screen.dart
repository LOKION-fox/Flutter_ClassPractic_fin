...
class AnimalDetailsScreen extends StatelessWidget {
  ...
  const AnimalDetailsScreen({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Животное')),
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              Text('Вид: ${animal.species}'),
              Text('Порода: ${animal.breed}'),
              Text('Возраст: ${animal.ageMonths} мес.'),
              Text('Пол: ${animal.sex}'),
              Text('Страна: ${animal.country}'),
              Text('Цена: ${animal.price.toStringAsFixed(0)} ₽'),
              const SizedBox(height: 16),
